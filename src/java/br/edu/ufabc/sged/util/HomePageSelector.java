...
public final class HomePageSelector {
    ...
    public static final String VIEW_GROUPS        = "visualizar grupos";
    public static final String EDIT_GROUP         = "editar grupo";
    public static final String VIEW_GROUP_MEMBERS = "visualizar usuarios do grupo";
